...
## Original data
soil <-read.csv("/Volumes/Personal/Metals/BRITPITS/SWEN_Britpits/SWEN.csv")
...
# Save file as shp
st_write(Arsenic_joined_sf, "/Volumes/Personal/Metals/BRITPITS/SWEN_Britpits/SWEN_Soil_distBritpits_AS.shp")
...
soil_sf <-st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_Britpits/SWEN_Soil_distBritpits_AS.shp")
...
st_write(Arsenic_Final_output, "/Volumes/Personal/Metals/BRITPITS/SWEN_Britpits/SWEN_Arsenic_Soil_BRITPITS_Final.shp")
