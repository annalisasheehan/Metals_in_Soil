...
####################################################
# Join SWEN and NSI datasets together 
####################################################

swen <- read.csv("/Users/annalisasheehan/Dropbox/Metals_BGS_work/Data/Original_Data/SWEN_Compiled_Surface_Soil_Data_NQ_no0.csv")

nsi <-read.csv("/Users/annalisasheehan/Dropbox/Metals_BGS_work/Data/Original_Data/NSI_Compiled_Surface_Soil_Data_NQ_no0.csv")
...
# Save file as shp
st_write(lead_joined_sf, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_PB.shp")
...
# Save file as shp
st_write(Arsenic_joined_sf, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_AS.shp")
...
# Save file as shp
st_write(Cadmium_joined_sf, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_CD.shp")
...
soil_sf <-st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_PB.shp")
...
st_write(Lead_Final_output, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Lead_Soil_BRITPITS_Final.shp")
...
soil_sf <-st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_AS.shp")
...
soil_sf_50m_cut <- st_drop_geometry(soil_sf_50m)
soil_sf_50m_cut <- subset(soil_sf_50m_cut, select=-c(SAMPLE_ ,ATLAS_C, Lead, Cadmium, 
                                                     BGS_REF, PIT_NAM, 
                                                     ALTERNA, PARENT_, PIT_STA, 
                                                     TYPE_OF, CMDTY_C, CMDTY_P,
                                                     LONGITU, LATITUD, PIT_ADD, 
                                                     AGE, LITHOST, OPERATO, DATE_UP, 
                                                     EPR_COD, PLANNIN, MPA_COD, SPONSOR, 
                                                     dist))
...
#100m 
soil_sf_100m_cut <- st_drop_geometry(soil_sf_100m)
soil_sf_100m_cut <- subset(soil_sf_100m_cut, select=-c(SAMPLE_ ,ATLAS_C, Lead, Cadmium, 
                                                       BGS_REF, PIT_NAM, 
                                                       ALTERNA, PARENT_, PIT_STA, 
                                                       TYPE_OF, CMDTY_C, CMDTY_P,
                                                       LONGITU, LATITUD, PIT_ADD, 
...
#1500m 
soil_sf_1500m_cut <- st_drop_geometry(soil_sf_1500m)
soil_sf_1500m_cut <- subset(soil_sf_1500m_cut, select=-c(SAMPLE_ ,ATLAS_C, Lead, Cadmium, 
                                                         BGS_REF, PIT_NAM, 
                                                         ALTERNA, PARENT_, PIT_STA, 
                                                         TYPE_OF, CMDTY_C, CMDTY_P,
                                                         LONGITU, LATITUD, PIT_ADD, 
...
#2000m 
soil_sf_2000m_cut <- st_drop_geometry(soil_sf_2000m )
soil_sf_2000m_cut <- subset(soil_sf_2000m_cut, select=-c( SAMPLE_ ,ATLAS_C, Lead, Cadmium, 
                                                          BGS_REF, PIT_NAM, 
                                                          ALTERNA, PARENT_, PIT_STA, 
                                                          TYPE_OF, CMDTY_C, CMDTY_P,
                                                          LONGITU, LATITUD, PIT_ADD, 
...
st_write(Arsenic_Final_output, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Arsenic_Soil_BRITPITS_Final.shp")
...
#Read in the Soil sites distance to Britpits AS shp.
soil_sf <-st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Soil_distBritpits_CD.shp")
...
st_write(Cadmium_Final_output, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Cadmium_Soil_BRITPITS_Final.shp")
...
lead <- st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Lead_Soil_BRITPITS_Final.shp")
...
st_write(lead_subset, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Lead_Soil_BRITPITS_Geology_Bedrock_Final.shp")

####################################################
# Arsenic
####################################################

arsenic <- st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Arsenic_Soil_BRITPITS_Final.shp")
...
arsenic_subset <- subset(arsenic_bedrock, select=-c(LEX_WEB, RANK, BED_EQ_D, MB_EQ_D, 
                                                    FM_EQ_D, SUBGP_EQ_D, GP_EQ_D,
                                                    SUPGP_EQ_D, SAMPLE_, ALTERNA, 
                                                    PARENT_, SPONSOR, MAP_SRC, MAP_WEB,
                                                    VERSION, RELEASED, LEX_RCS_I,
                                                    NOM_SCALE, BGSREF, NOM_BGS_YR,
                                                    UUID, BGSTYPE, OPERATO, DATE_UP,
                                                    EPR_COD, PLANNIN, MPA_COD))

st_write(arsenic_subset, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Arsenic_Soil_BRITPITS_Geology_Bedrock_Final.shp")

####################################################
# Cadmium
####################################################

cadmium <- st_read("/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Cadmium_Soil_BRITPITS_Final.shp")
...
st_write(cadmium_subset, "/Volumes/Personal/Metals/BRITPITS/SWEN_NSI_Britpits/SWEN_NSI_Cadmium_Soil_BRITPITS_Geology_Bedrock_Final.shp")
